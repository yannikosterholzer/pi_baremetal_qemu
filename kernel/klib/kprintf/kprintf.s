...
@************************************************************************************
kprintf:    						@ formatstring in r1 // output-type in r2 // Parameter im Stack: Die zuerst benutzten Argumente müssen zuletzt gepusht werden
	push 	{lr}                   
	push 	{r11}
	mov 	r11, sp
	sub 	sp, sp, #STACKMAX	    
